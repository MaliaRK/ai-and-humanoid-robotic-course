...
-   [x] T006 [US2] Create `chapter2-nodes-topics-services.md` in `module1-ros2-nervous-system/docs/`
-   [x] T007 [US2] Draft content for Nodes, Publishers & Subscribers, and Services & Actions in `module1-ros2-nervous-system/docs/chapter2-nodes-topics-services.md`
-   [x] T008 [US2] Create a minimal Pub/Sub Python example in `module1-ros2-nervous-system/examples/ch2_pubsub.py`
-   [x] T009 [US2] Embed the Pub/Sub example in `module1-ros2-nervous-system/docs/chapter2-nodes-topics-services.md`
...
-   [x] T010 [US3] Create `chapter3-rclpy.md` in `module1-ros2-nervous-system/docs/`
-   [x] T011 [US3] Draft content for "Intro to rclpy" and "Creating Python Nodes" in `module1-ros2-nervous-system/docs/chapter3-rclpy.md`
-   [x] T012 [US3] Create an example ROS 2 package structure in `module1-ros2-nervous-system/examples/ch3_my_package/`
-   [x] T013 [US3] Add a Python node example to `module1-ros2-nervous-system/examples/ch3_my_package/my_package/my_node.py`
...
-   [x] T014 [US4] Create `chapter4-urdf.md` in `module1-ros2-nervous-system/docs/`
-   [x] T015 [US4] Draft content for "What is URDF", "Links & joints" in `module1-ros2-nervous-system/docs/chapter4-urdf.md`
-   [x] T016 [US4] Create a simple humanoid URDF file in `module1-ros2-nervous-system/examples/ch4_humanoid.urdf`
-   [x] T017 [US4] Add instructions for visualizing the URDF in RViz2 to `module1-ros2-nervous-system/docs/chapter4-urdf.md`
...
-   [x] T018 [US5] Create `chapter5-middleware-in-action.md` in `module1-ros2-nervous-system/docs/`
-   [x] T019 [US5] Draft content for "Real-world ROS 2 communication flow" and "Multi-node coordination" in `module1-ros2-nervous-system/docs/chapter5-middleware-in-action.md`
-   [x] T020 [US5] Create a case study of a humanoid limb controller, including a Mermaid diagram of the node graph in `module1-ros2-nervous-system/docs/chapter5-middleware-in-action.md`
-   [x] T021 [US5] Create an example launch file for the case study in `module1-ros2-nervous-system/examples/ch5_limb_controller.launch.py`
...
-   [x] T022 Perform final content review for all chapters for clarity and technical accuracy.
-   [x] T023 Run Docusaurus build process to validate documentation structure and rendering.