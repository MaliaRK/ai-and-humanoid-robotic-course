...
```text
# Default Structure for Book Modules (based on project constitution)
moduleX-name/
├── sim/            # Isaac Sim, Gazebo, Unity simulation assets/code
├── ros/            # ROS 2 nodes, packages, launch files
├── manipulator/    # Isaac Manipulator or other motion planning
├── bridge/         # Communication layer between modules/external systems
├── api/            # REST/WebSocket API implementations
